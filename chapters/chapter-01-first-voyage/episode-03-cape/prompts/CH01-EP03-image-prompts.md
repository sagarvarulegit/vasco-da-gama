# Chapter 1 Episode 3 — Dramatized Image Prompt Pack (Gemini 2.5 Flash Image)

**Episode:** `CH01-EP03 — Cape of Good Hope (Dramatized)`  
**Master Style:** `MASTER_STYLE_02` (High-drama European historical oil painting, intense chiaroscuro, visceral textures, atmospheric depth, cinematic emotion, no CGI sheen)  
**Negative Prompt Standard:** See [`reference/negative-prompt.md`](../../../../reference/negative-prompt.md)

---

## Scene 01: Careening and Wood Gathering at St Helena Bay
...
* **Target Output:** `images/episode-03/CH01-EP03-S01-v2.png`
...
## Scene 05: Rounding the Cape of Good Hope

* **Scene ID:** `CH01-EP03-S05`
* **Historical Date:** Midday, 22 November 1497 (Wednesday)
* **Location:** Cape of Good Hope (*Cabo da Boa Esperança*)
* **Target Output:** `images/episode-03/CH01-EP03-S05-v2.png`
...
## Scene 06: Music and Trade at Mossel Bay

* **Scene ID:** `CH01-EP03-S06`
* **Historical Date:** 25–27 November 1497
* **Location:** Beach at Angra de São Brás (Mossel Bay)
* **Target Output:** `images/episode-03/CH01-EP03-S06-v2.png`
...
## Scene 08: Departure into the Unknown East

* **Scene ID:** `CH01-EP03-S08`
* **Historical Date:** Morning, 8 December 1497
* **Location:** Departing Angra de São Brás into the Indian Ocean
* **Target Output:** `images/episode-03/CH01-EP03-S08-v2.png`
